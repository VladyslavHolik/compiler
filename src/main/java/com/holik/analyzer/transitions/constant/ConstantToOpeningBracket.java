...
@Component
public class ConstantToOpeningBracket implements Transition {
    ...
    public Optional<ParseError> getError(List<LexemeValue> lexemes, Integer currentLexemeIndex) {
        ...
        return Optional.of(new ParseError(index, "No operator is present between constant and opening bracket"));
    }
