...
@Component
public class ClosingBracketToConstant implements Transition {
    ...
    public Optional<ParseError> getError(List<LexemeValue> lexemes, Integer currentLexemeIndex) {
        ...
        return Optional.of(new ParseError(index, "Constant is not allowed after bracket without any operation"));
    }
