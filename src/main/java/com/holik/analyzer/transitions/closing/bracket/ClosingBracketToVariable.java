...
@Component
public class ClosingBracketToVariable implements Transition {
    ...
    public Optional<ParseError> getError(List<LexemeValue> lexemes, Integer currentLexemeIndex) {
        ...
        return Optional.of(new ParseError(index, "Variable is not allowed after bracket without any operation"));
    }
