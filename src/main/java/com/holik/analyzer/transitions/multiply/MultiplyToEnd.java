...
@Component
public class MultiplyToEnd implements Transition {
    ...
    public Optional<ParseError> getError(List<LexemeValue> lexemes, Integer currentLexemeIndex) {
        return Optional.of(new ParseError(lexemes.get(currentLexemeIndex).getIndex(), "No value is present after multiply operator"));
    }
}
