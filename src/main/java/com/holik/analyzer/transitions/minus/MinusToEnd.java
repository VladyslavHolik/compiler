...
@Component
public class MinusToEnd implements Transition {
    ...
    public Optional<ParseError> getError(List<LexemeValue> lexemes, Integer currentLexemeIndex) {
        return Optional.of(new ParseError(lexemes.get(currentLexemeIndex).getIndex(), "Expression cannot end without value after minus"));
    }
}
